...
export const en: SiteContent = {
  ...
  science: {
    ...
    mechanism: [
      { index: "01", title: "Absorption", body: "Red light at 630 and 660 nanometres passes through the epidermis and is absorbed within the energy-producing structures of the cell." },
      ...
      { index: "03", title: "Synthesis", body: "With more energy available, fibroblasts are supported in producing collagen and elastin. Dermal density is maintained, and the skin above keeps more of its ability to resist and recover from folding." },
    ],
